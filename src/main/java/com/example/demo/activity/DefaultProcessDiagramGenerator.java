...
import org.activiti.image.impl.*;
...
public class DefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public DefaultProcessDiagramGenerator(final double scaleFactor) {
        ...
        this.activityDrawInstructions.put(StartEvent.class, new ActivityDrawInstruction() {
            public void draw(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
        ...
        this.artifactDrawInstructions.put(TextAnnotation.class, new ArtifactDrawInstruction() {
            public void draw(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
    ...
    protected org.activiti.image.impl.DefaultProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedActivities, List<String> highLightedFlows, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader, double scaleFactor) {
        this.prepareBpmnModel(bpmnModel);
        org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    ...
    protected void drawActivity(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedActivities, List<String> highLightedFlows, double scaleFactor) {
    ...
    protected static List<GraphicInfo> connectionPerfectionizer(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, BaseElement sourceElement, BaseElement targetElement, List<GraphicInfo> graphicInfoList) {
    ...
    protected void drawArtifact(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
    ...
    private static void drawHighLight(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
        processDiagramCanvas.drawHighLight((int)graphicInfo.getX(), (int)graphicInfo.getY(), (int)graphicInfo.getWidth(), (int)graphicInfo.getHeight());
    }

    private static void drawHighLightRed(org.activiti.image.impl.DefaultProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
//        processDiagramCanvas.drawHighLightRed((int)graphicInfo.getX(), (int)graphicInfo.getY(), (int)graphicInfo.getWidth(), (int)graphicInfo.getHeight());
    ...
    protected static org.activiti.image.impl.DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader) {
        ...
        return new org.activiti.image.impl.DefaultProcessDiagramCanvas((int)maxX + 10, (int)maxY + 10, (int)minX, (int)minY, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    }
    ...
    protected interface ArtifactDrawInstruction {
        void draw(org.activiti.image.impl.DefaultProcessDiagramCanvas var1, BpmnModel var2, Artifact var3);
    }

    protected interface ActivityDrawInstruction {
        void draw(org.activiti.image.impl.DefaultProcessDiagramCanvas var1, BpmnModel var2, FlowNode var3);
    }
}
